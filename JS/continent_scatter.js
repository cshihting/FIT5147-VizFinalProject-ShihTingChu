...
var svg = d3.select("continent_content").append("svg")
...
var tooltip = d3.select("continent_content").append("div")
    .attr("class", "tooltip")
    .style("opacity", 0);
...
d3.csv("../CSV/continent_time.csv", function(error, data) {
    ...
    svg.selectAll("circle") 
        ...
        .on("mouseover", function(d) {
            ...
            tooltip.html(d.continent + "<br/> Year: " + xValue(d)
