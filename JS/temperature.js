...
// setup y (left)
var yValue = function(d) { return d['temperature(Celsius)'];},
...
var svg = d3.select("temp_content")
            .append("svg")
...
var tooltip = d3.select("temp_content")
                .append("div")
                .attr("class", "tooltip")
                .style("opacity", 0);
...
d3.csv("../CSV/temp.csv", function(error, data) {
    ...
    svg.selectAll("circle")
        ...
        .on("mouseover", function(d) {
            ...
            + "<br/> Temperature(Celsius): " + Math.ceil(yValue(d)))
